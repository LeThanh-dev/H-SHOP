...
?>
 <a href="?mod=hoadon&act=capnhat&id=<?= $data['0']['MaHD'] ?>" class="btn btn-primary">Giao thành công</a>
<a href="?mod=hoadon&act=capnhat1&id=<?= $data['0']['MaHD'] ?>" class="btn btn-secondary">Giao thất bại</a>
