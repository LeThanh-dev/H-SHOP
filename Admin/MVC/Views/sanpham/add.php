...
<div class="form-group">
  ...
  <select id="MaLSP" name="MaLSP" class="form-control">
    ...
    <div class="form-group">
      ...
      <input type="text" required class="form-control" id="TenSP" placeholder="Nhập tên sản phẩm" name="TenSP" maxlength="255">
    ...
    <div class="form-group">
      ...
      <input type="checkbox" id="" placeholder="" value="1" name="TrangThai" checked><em>(Check cho phép hiện thị sản phẩm)</em>
    </div>
