			...
			<div class="col-sm-6">
				<div class="main-input single-cart-form padding60">
					...
					<div class="custom-input">
						<form id="checkout-form" action="?act=checkout&xuli=save" method="post">
							...
							<input type="text" name="SDT" placeholder="Số điện thoại.." required  pattern='0[0-9]{9}' maxLength='10'  value="<?=$_SESSION['login']['SDT']?>"/>
						...
						<form id="cart-form" method ="POST" enctype="application/x-www-form-urlencoded" action="Views/cart/thanhtoanmomoATM.php">               
							  <input  style="background-color: black; color:white; margin-top: 10px; padding: 10px;" id="order" type="submit" name="order_momo" value="Thanh toán qua ATM code MOMO" >
                				<input type="hidden" name ="total" value="<?=($count+30000)?>">           
             		 	</form> 	
