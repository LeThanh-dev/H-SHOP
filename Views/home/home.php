            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">DỤNG CỤ NHÀ BẾP <span></span></a></li>
                            <li><a data-toggle="tab" href="#popular">THIẾT BỊ VỆ SINH <span></span></a></li>
                            <li><a data-toggle="tab" href="#best">ĐỒ ĐIỆN</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="single-product">
                                            <div class="product-f">
                                                ...
                                                <div class="actions-btn"> 
                                                    <a title="Thêm vào giỏ hàng" href="?act=cart&xuli=add&id=<?= $data_sanpham1[$i]['MaSP'] ?>"><i class="mdi mdi-cart"></i></a>
                                            ...
                                            <div class="product-dsc">
                                                ...
                                                <span>Giá: <?= number_format($data_sanpham1[$i]['DonGia']) ?> VNĐ</span>
                                            </div>
                                        </div>
                                    </div>
                        <?php }?>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product">
                                            <div class="product-f">
                                                ...
                                                <div class="actions-btn">
                                                    <a title="Thêm vào giỏ hàng" href="?act=cart&xuli=add&id=<?= $data_sanpham2[$i]['MaSP'] ?>"><i class="mdi mdi-cart"></i></a>
                                            ...
                                            <div class="product-dsc">
                                                ...
                                                <span>Giá: <?= number_format($data_sanpham2[$i]['DonGia']) ?> VNĐ</span>
                                            </div>
                                        </div>
                                    </div>
                        <?php }?>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product">
                                            <div class="product-f">
                                                ...
                                                <div class="actions-btn">
                                                    <a href="?act=cart&xuli=add&id=<?= $data_sanpham3[$i]['MaSP'] ?>" title="Thêm vào giỏ hàng"><i class="mdi mdi-cart"></i></a>
                                            ...
                                            <div class="product-dsc">
                                                ...
                                                <span>Giá: <?= number_format($data_sanpham3[$i]['DonGia']) ?> VNĐ</span>
                                            </div>
                                        </div>
                                    </div>
                        <?php }?>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="colect-text ">
                    ...
                    <a href="?act=cart&xuli=add&id=<?= $data_random['0']['MaSP'] ?>">Mua ngay <i class="mdi mdi-arrow-right"></i></a>
                </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="colect-text ">
                    ...
                    <a href="?act=cart&xuli=add&id=<?= $data_random['1']['MaSP'] ?>">Mua ngay <i class="mdi mdi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="single-products  products-two section-padding extra-padding-bottom">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <h2 style = "    font-size: 24px;">SẢN PHẨM MỚI NHẤT</h2>
                </div>
            </div>
        </div>
        <div class="wrapper">
