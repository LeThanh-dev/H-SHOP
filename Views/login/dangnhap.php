		...
		<div class="custom-input">
			...
			<form action="?act=taikhoan&xuli=dangnhap" method="post" id="form1">
				...
				<div class="submit-text">
					<button style=" margin-right: 10px; " name="submit" type="submit" form="form1" class="btn-sign-in">Đăng nhập</button>
					<a  type="submit"  form="form1"  style=" padding:0 30px; margin: 0; " href="?act=taikhoan&dk">Đăng ký</a>
				</div>
			</form>
		</div>
	</div>
