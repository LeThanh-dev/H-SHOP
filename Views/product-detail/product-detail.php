                ...
                <div class="col-xs-12">
                    <div class="pages-title-text text-center">
                        ...
                        <ul class="text-left">
                            ...
                            <li><span> / </span><a href="?act=shop">Sản phẩm</a></li>
                ...
                <div class="single-list-view">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <div class="quick-right">
                            <div class="list-text">
                                <h3 style = "font-weight: bold;"><?= $data['TenSP'] ?></h3>
                                ...
                                <h5 style = "margin-top:32px">Giá: <?=number_format($data['DonGia'])?> VNĐ</h5>
                               
                                <p style = "margin-bottom: 10px; font-weight:bold">Mô tả:</p>
                                <?= $data['MoTa'] ?>
                              
                                <div class="list-btn" style = "    display: inline-block;">
