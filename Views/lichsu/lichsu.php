                                                        ...
                                                        <tr>
                                                            <?php if ($SoSanPham_temp > 1) { ?>
                                                                ...
                                                                <?php if ($temp['SanPham'][0]['TrangThai'] == 0) { ?>
                                                                    ...
                                                                    <td style="color: #2287ef;" rowspan="<?= $SoSanPham_temp ?>">
                                                                        ...
                                                                        Đợi duyệt
                                                                        <a style="font-size: 10px;padding: 6px 8px;margin-top: 6px;" style="font-size: 10px;padding: 6px 8px;margin-top: 6px;" class="btn btn-danger" href="?act=history&xuli=delete&id=<?= $temp['MaHD'] ?>"> Hủy đơn</a>
                                                            ...
                                                            <?php if ($temp['SanPham'][0]['TrangThai'] == 0) { ?>
                                                                ...
                                                                <td style="color: #2287ef;">Đợi duyệt
                                                                    ...
                                                                    <a style="font-size: 10px;padding: 6px 8px;margin-top: 6px;" class="btn btn-danger" href="?act=history&xuli=delete&id=<?= $temp['MaHD'] ?>"> Hủy đơn</a>
                                                                </td>
                                                            <?php } else if ($temp['SanPham'][0]['TrangThai'] == 1) { ?>
                                                                <td style="color: #ff9900;">Đang giao</td>
                                                            <?php } else if ($temp['SanPham'][0]['TrangThai'] == 3) { ?>
