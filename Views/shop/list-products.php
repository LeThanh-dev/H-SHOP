			...
			<div class="single-product">
				<div class="product-f">
					...
					<div class="actions-btn"> 
						<a title="Thêm vào giỏ hàng" href="?act=cart&xuli=add&id=<?=$value['MaSP']?>"><i class="mdi mdi-cart"></i></a>
				...
				<div class="product-dsc">
					<p>
						...
						overflow: hidden;
						padding: 0 6px;"href="?act=detail&id=<?=$value['MaSP']?>"><?=$value['TenSP']?>
						</a>
					</p>
					<!-- <div class="ratting">
					...
					<span>Giá: <?=number_format($value['DonGia'])?> VNĐ</span>
				</div>
			</div>
		</div>
		<?php }}else{
